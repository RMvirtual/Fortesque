...
int main()
{
    ...
    // Texture coordinate vertex shader attribute.
    glVertexAttribPointer(
    ...
    // glVertexAttribPointer), no need to fill it; the VBO's data 
    // already contains all we need (it's already bound, but we do it
...
{
    // Ensure the viewport matches the new window dimensions; note that 
...
void mouse_callback(GLFWwindow *window, double xposIn, double yposIn)
{
    ...
    float yoffset = lastY - ypos; // Y coordinates run bottom to top.
